# ArduiTouch-MKR-Codelock
Different people asked me for a very simple code example for our [ArduiTouch MKR](https://www.hwhardsoft.de/english/projects/arduitouch-mkr/) set without any bells and whistles. This is a very simple codelock / keypad example for ArduiTouch MKR (equipped with any Arduino MKR board) to demonstate the basic graphic and audio features of the ArduiTouch kit.
